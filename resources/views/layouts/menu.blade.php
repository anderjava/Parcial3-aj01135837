...
<li class="{{ Request::is('alumnos*') ? 'active' : '' }}">
    <a href="{{ route('alumnos.index') }}"><i class="fa fa-users"></i><span>Alumnos</span></a>
</li>
@endcan
...
<li class="{{ Request::is('nota*') ? 'active' : '' }}">
    <a href="{{ route('nota.index') }}"><i class="fa fa-clipboard"></i><span>Notas</span></a>
</li>
@endcan
...
<li class="{{ Request::is('cursos*') ? 'active' : '' }}">
    <a href="{{ route('cursos.index') }}"><i class="fa fa-address-book"></i><span>Cursos</span></a>
</li>
@endcan
